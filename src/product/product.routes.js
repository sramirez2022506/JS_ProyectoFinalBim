...
import { existProduct, existProductName } from "../helpers/db-validator.js";
...
router.get("/", validateJWT, hasRole, getProduct);
...
router.get("/outOfStock", validateJWT, hasRole, outOfStock);

router.get("/bestSeller", validateJWT, hasRole, bestSeller);
